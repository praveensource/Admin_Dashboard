  ...
  return (
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      <div className='float-right h-screen dark:text-gray-200 bg-white dark:[#484b52] w-400'>
        ...
        <button type='button' onClick={()=> setThemeSettings(false)} style={{color:'rgb(153,171,180', borerRadius:'50%'}} className='text-2xl p-3 hover:drop-shadow-xl hover:bg-light-gray'>
          < MdOutlineCancel />
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4 ' >
          ...
          <div className='mt-4'>
            ...
            onChange={setMode} checked={currentMode==='Light'} />
          ...
          <div className='mt-4'>
            ...
            onChange={setMode} checked={currentMode==='Dark'} />
